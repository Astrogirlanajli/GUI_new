...
btn_var = tk.StringVar(value="Load ML model(s)")
menu_btn = ttk.Menubutton(top_frame, textvariable=btn_var, direction="below", style="Black.TMenubutton")
...
menu_btn.pack(padx=20, pady=20, fill="x")
...
# Play Button
play_button = tk.Button(control_button_row, text="▶", **button_config)
